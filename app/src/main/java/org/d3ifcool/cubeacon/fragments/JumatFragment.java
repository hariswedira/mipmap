...
public class JumatFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        rvSchedule = view.findViewById(R.id.rv_list_jumat);
        rvOnGoing = view.findViewById(R.id.rv_list_on_jumat);
        onGoing = view.findViewById(R.id.tv_ongoing_jumat);
...
//                    Toast.makeText(getContext(), "No "+timeNow, Toast.LENGTH_SHORT).show();
    ...
    private void initDataSchedule(String title){
        ...
        DatabaseReference jadwal = database.getReference("schedule").child(title).child("jumat");
