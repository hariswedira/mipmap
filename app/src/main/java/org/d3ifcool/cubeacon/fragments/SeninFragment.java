...
import org.d3ifcool.cubeacon.ChooseRoomActivity;
...
public class SeninFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        onGoing = view.findViewById(R.id.tv_ongoing);
...
//                    Toast.makeText(getContext(), "No "+timeNow, Toast.LENGTH_SHORT).show();
    ...
    private void initDataSchedule(String title){
        ...
        DatabaseReference jadwal = database.getReference("schedule").child(title).child("senin");
