...
public class KamisFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        rvSchedule = view.findViewById(R.id.rv_list_kamis);
        rvOnGoing = view.findViewById(R.id.rv_list_on_kamis);
        onGoing = view.findViewById(R.id.tv_ongoing_kamis);
...
//                    Toast.makeText(getContext(), "No "+timeNow, Toast.LENGTH_SHORT).show();
    ...
    private void initDataSchedule(String title){
        ...
        DatabaseReference jadwal = database.getReference("schedule").child(title).child("kamis");
