...
public class ProximityContentAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView title = convertView.findViewById(R.id.title_range);
        TextView subtitle = convertView.findViewById(R.id.subtitle_range);

        title.setText(content.getTitle());
        subtitle.setText(content.getSubtitle());

        convertView.setBackgroundColor(EstimoteUtils.getEstimoteColor(content.getTitle()));
