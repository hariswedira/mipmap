                ...
                ruangan.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                            ...
                            if (a.getType().equalsIgnoreCase("Classroom")){
                                classList.add(a);
                            }
                        }
            ...
            public void onClick(View view) {
                ...
                ruangan.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                            Room a = dataSnapshot1.getValue(Room.class);
                            if (a.getType().equalsIgnoreCase("Academic")){
                                labList.add(a);
                            }
                        }
            ...
            public void onClick(View view) {
                ...
                ruangan.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                            Room a = dataSnapshot1.getValue(Room.class);
                            if (a.getType().equalsIgnoreCase("research")){
                                risetList.add(a);
                            }
                        }
...
//        listRooms.add(new Room("G1",getResources().getString(R.string.about),"Floor 1", "Amir Hasanudin Fauzi, ST., MT.", "08123456789", "research", "https://firebasestorage.googleapis.com/v0/b/mipmap-apps.appspot.com/o/lab.png?alt=media&token=ef8d115e-ad4b-461c-8817-7b395147c26d", "https://dif.telkomuniversity.ac.id/wp-content/uploads/2014/12/Amir-Hasanudin-Fauzi-ST.-MT-150x150.jpg","14880088","https://images.unsplash.com/photo-1519389950473-47ba0277781c?ixlib=rb-1.2.1&auto=format&fit=crop&w=1650&q=80"));
//        listRooms.add(new Room("G5",getResources().getString(R.string.about_g5),"Floor 1", "Amir Hasanudin Fauzi, ST., MT.", "08123456789", "Classroom", "https://firebasestorage.googleapis.com/v0/b/mipmap-apps.appspot.com/o/class.png?alt=media&token=d3009015-f21b-4398-bcce-a71558392d0b", "https://dif.telkomuniversity.ac.id/wp-content/uploads/2014/12/Amir-Hasanudin-Fauzi-ST.-MT-150x150.jpg","14880088","https://images.unsplash.com/photo-1580582932707-520aed937b7b?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2089&q=80"));
//        listRooms.add(new Room("G6",getResources().getString(R.string.about_g6),"Floor 1", "Amir Hasanudin Fauzi, ST., MT.", "08123456789", "Classroom", "https://firebasestorage.googleapis.com/v0/b/mipmap-apps.appspot.com/o/class.png?alt=media&token=d3009015-f21b-4398-bcce-a71558392d0b", "https://dif.telkomuniversity.ac.id/wp-content/uploads/2014/12/Amir-Hasanudin-Fauzi-ST.-MT-150x150.jpg","14880088","https://images.unsplash.com/photo-1580582932707-520aed937b7b?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2089&q=80"));
//        listRooms.add(new Room("G7",getResources().getString(R.string.about_g7),"Floor 1", "Amir Hasanudin Fauzi, ST., MT.", "08123456789", "Classroom", "https://firebasestorage.googleapis.com/v0/b/mipmap-apps.appspot.com/o/class.png?alt=media&token=d3009015-f21b-4398-bcce-a71558392d0b", "https://dif.telkomuniversity.ac.id/wp-content/uploads/2014/12/Amir-Hasanudin-Fauzi-ST.-MT-150x150.jpg","14880088","https://images.unsplash.com/photo-1580582932707-520aed937b7b?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2089&q=80"));
//        listRooms.add(new Room("G9",getResources().getString(R.string.about_g9),"Floor 1", "Amir Hasanudin Fauzi, ST., MT.", "08123456789", "Classroom", "https://firebasestorage.googleapis.com/v0/b/mipmap-apps.appspot.com/o/class.png?alt=media&token=d3009015-f21b-4398-bcce-a71558392d0b", "https://dif.telkomuniversity.ac.id/wp-content/uploads/2014/12/Amir-Hasanudin-Fauzi-ST.-MT-150x150.jpg","14880088","https://images.unsplash.com/photo-1580582932707-520aed937b7b?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2089&q=80"));
